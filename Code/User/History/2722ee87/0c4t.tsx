  ...
  const rowActions = getSalesRowActions(
    {
      ...
      onDelete: (row) => handleDelete(row, fetchAllData, companySettings),
      onReturn: (row) => handleReturn(row, fetchAllData, companySettings),
    ...
    <PageWrapper>
      ...
      >
        ...
        <ContentTable
          ...
          data={sales}
          loading={loading}
          searchPlaceholder="Search by sale number, customer..."
          filters={filters}
