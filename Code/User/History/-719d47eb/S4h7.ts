...
} from './items-master/medicinesManagement'
import {
...
import { CreditsManagement, ROUTE as CreditsManagementRoute } from './credits'
import {
  CompanySettings,
...
export const routes: RouteType[] = [
  ...
  // ============================================================================
  {
    ...CreditsManagementRoute,
    element: CreditsManagement,
    protected: true,
    requiredPermissions: [Permission.CREDITS_READ],
    allowedRoles: [
      Role.company_admin,
      Role.area_admin,
      Role.store_admin,
    ...
    // Sales Manager has view-only access (handled in component)
  },
