...
export const getIncomeRowActions = (
...
): RowAction[] => [
  {
    ...
    // Always visible for all records
  },
  {
    label: 'Approve',
    ...
    // Hidden for system-generated records and records already approved/posted/cancelled
    condition: (row) =>
      !row.is_system && canPerformAction(row, 'approve').allowed,
  },
  {
    ...
    // Hidden for system-generated records and records not ready to post
    condition: (row) => !row.is_system && canPerformAction(row, 'post').allowed,
  },
  {
    label: 'Edit',
    ...
    tooltip: 'Edit Income',
    // Hidden for system-generated records
    condition: (row) => !row.is_system && canPerformAction(row, 'edit').allowed,
  },
  {
    label: 'Delete',
    ...
    // Hidden for system-generated records
    condition: (row) =>
      !row.is_system && canPerformAction(row, 'delete').allowed,
  },
]
