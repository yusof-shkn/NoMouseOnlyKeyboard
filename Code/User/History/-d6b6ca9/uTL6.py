...
def copy_template_data(target_company_id: int) -> bool:
    ...
    try:
        ...
        if src_ic:
            ...
            db_upsert(
                "income_categories", new_ic, on_conflict="company_id,category_name"
            )
    ...
    try:
        ...
        if src_ec:
            ...
            db_upsert(
                "expense_categories", new_ec, on_conflict="company_id,category_name"
            )
    ...
    try:
        ...
        if src_units:
            ...
            for unit_list in (base, derived):
                new_units = [_strip_id(u, dst) for u in unit_list]
                if new_units:
