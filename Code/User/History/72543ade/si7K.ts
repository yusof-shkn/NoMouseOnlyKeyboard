...
export const getCategoryById = async (
  ...
  return {
    data: {
      ...result.data,
      product_count: productCount || 0,
SUPABASE_URL=https://sybubuqvtjnrypmmzevf.supabase.co
SUPABASE_ANON_KEY=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InN5YnVidXF2dGpucnlwbW16ZXZmIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjE2NTEzOTgsImV4cCI6MjA3NzIyNzM5OH0.iBm29HiMaKR_lk1T4I2hiQoGP7mmc6aF57Phe0qr4T0
