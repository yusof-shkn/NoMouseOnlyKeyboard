...
export const canPerformAction = (
  ...
  // System-generated income is read-only — only View is allowed
  if (income.is_system) {
    const source = income.reference_type || 'sale'
    return {
      allowed: false,
      reason: `Auto-generated from ${source}. Only viewing is allowed on system records.`,
    }
  }
