...
**2. Pricing math bug for insured orders — delivery fee is always charged to insurance even the rider is selected walk in its wrong at first we should not show the delivery fee remove them at all orderr details and we will show it when we select rider **
