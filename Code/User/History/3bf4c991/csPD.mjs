j// ─── Run once to create staff accounts ───────────────────────────────────────
...
const JUBILEE_INSURANCE_PROVIDER_ID = '11111111-0001-0001-0001-000000000001'
const AAR_INSURANCE_PROVIDER_ID = '11111111-0002-0002-0002-000000000002'
const accounts = [
  {
    phone: '+256700000001',
    password: 'Test1234!',
  ...
  },
  {
    phone: '+256700000004',
    password: 'Test1234!',
    name: 'Jubilee Insurance Staff',
    role: 'insurance_staff',
    email: 'jubilee.insurance@medideliverysos.com',
    insurance_provider_id: JUBILEE_INSURANCE_PROVIDER_ID,
  },
  {
    phone: '+256700000005',
    password: 'Test1234!',
    name: 'AAR Insurance Staff',
    role: 'insurance_staff',
    email: 'aar.insurance@medideliverysos.com',
    insurance_provider_id: AAR_INSURANCE_PROVIDER_ID,
  },
  {
    phone: '+256700000003',
    password: 'Test1234!',
