...
const StockAdjustment = () => {
  ...
  const rowActions = getStockAdjustmentRowActions({
    onView: (row) => dispatch(openModal({ type: 'view-stock-adjustment', size: 'lg', props: { adjustment: row } })),
    ...
    <PageWrapper>
      ...
      >
        ...
        <ContentTable
          ...
          onRowClick={(row) => dispatch(openModal({ type: 'view-stock-adjustment', size: 'lg', props: { adjustment: row } }))}
          selectable={true}
        />
      </Container>
    </PageWrapper>
