...
export const menuData: MenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      { name: 'Medicines', link: '/items-master/medicines', icon: IconPackage },

      {
        name: 'Categories',
        link: '/items-master/medicines/categories',
        icon: IconTags,
      },

      {
        name: 'Units',
        link: '/items-master/medicines/units',
