...
/**
 * Column definitions for Balance Sheet with dark mode support
 */
export const getBalanceSheetColumns = (currency: string = 'UGX'): any[] => [
  {
    header: 'Account Code',
    ...
    render: (row: BalanceSheetEntry) => {
      ...
      return (
        <Box style={{ minWidth: 0 }}>
          ...
          {/* Safely handle null/undefined account_subtype */}
          {row.account_subtype ? (
            <Text
              c="dimmed"
              size="xs"
...
/**
 * Statistics cards with enhanced visual design
 */
