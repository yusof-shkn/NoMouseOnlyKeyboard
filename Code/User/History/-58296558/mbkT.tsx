...
const Areas = () => {
  ...
  const fetchAreas = useCallback(async () => {
    ...
    try {
      ...
      const areasResult = await fetchAreasData({
        ...
        parentAreaId:
          parentAreaFilter === 'root'
            ? null
            : parentAreaFilter !== 'all'
              ? parseInt(parentAreaFilter)
              : undefined,
        hasAdmin:
  ...
  const fetchAllData = useCallback(async () => {
    ...
    try {
      ...
      const rootAreas = areasResult.areasData.filter((a) => !a.parent_area_id)
      setParentAreas(rootAreas)
    } catch (err) {
  ...
  const filters = useMemo(
    () =>
      getAreaFilters({
        ...
        onParentAreaChange: (value) => {
          console.log('🔍 Parent area filter changed:', value)
          setParentAreaFilter(value)
          setCurrentPage(1)
        },
        ...
        currentParentAreaFilter: parentAreaFilter,
