            ...
            {allStaff.length > 1 ? (
              <Box p={16}>
                <Text
                  ...
                  style={{ fontFamily: "'DM Sans',sans-serif" }}
                >
                  Approvals and verifications are attributed to the selected
                  actor
                </Text>
                <Group
                  gap={10}
                    ...
                    return (
                      ...
                      >
                        ...
                        <Text
                          size="xs"
                          fw={700}
                          c={isActive ? SavedColors.Primaryblue : '#0d1f3c'}
                          ta="center"
                          style={{
                            fontFamily: "'DM Sans',sans-serif",
                            lineHeight: 1.3,
                ...
                <Group gap={12}>
                  ...
                  <Box>
                    ...
                    <Text
                      ...
                      c="dimmed"
                    >
                      Create more staff accounts below to enable actor switching
                    </Text>
                  </Box>
                </Group>
              </Box>
        ...
        <Appear $delay={150}>
          ...
          >
            ...
            <Badge
              ...
              variant="light"
            >
              {staffProfiles.length} profile
              {staffProfiles.length !== 1 ? 's' : ''}
            </Badge>
          </Group>
          <Card style={{ marginBottom: 24 }}>
                  ...
                  >
                    ...
                    <Group gap={6}>
                      <Button
                        ...
                        onClick={() =>
                          navigate('/insurance/add-profile?edit=' + p.id)
                        }
                      >
                        Edit
                      </Button>
                      {!p.is_main && (
                        <Button
                          ...
                          onClick={async () => {
                            if (
                              !window.confirm(
                                `Delete "${p.display_name}"? This cannot be undone.`,
                              )
                            )
                              return
                            const { error } = await supabase
                            ...
                            if (error) {
                              ...
                              notifications.show({
                                title: 'Deleted',
                                message: `${p.display_name} removed.`,
                                color: 'teal',
                                autoClose: 2500,
                              })
            ...
            <MenuRow onClick={() => navigate('/insurance/add-profile')}>
              ...
              <Box style={{ flex: 1 }}>
                ...
                <Text
                  ...
                  c="dimmed"
                >
                  Same login — just a different named profile
                </Text>
              </Box>
              <TbChevronRight
                size={16}
            ...
            <MenuRow onClick={() => setSignOutOpen(true)}>
              ...
              <Box style={{ flex: 1 }}>
                ...
                <Text
                  ...
                  c="dimmed"
                >
                  {staffInfo?.email ?? displayProvider}
                </Text>
              </Box>
              <TbAlertCircle
                size={15}
