      ...
      .then(({ data }) => {
        ...
        for (const n of incoming) {
          if (!n.is_read && !seenNotifIdsRef.current.has(n.id)) {
            ...
            const color =
              n.type === 'insurance_verified'
                ? 'teal'
                : n.type === 'insurance_rejected'
                  ? 'red'
                  : n.type === 'delivered'
                    ? 'teal'
                    : n.type === 'pricing_ready'
                      ? 'orange'
                      : n.type === 'out_for_delivery'
                        ? 'cyan'
                        : n.type === 'delivery_request'
                          ? 'violet'
                          : 'blue'
        ...
        <Box>
          ...
          >
            ...
            <Text
              ...
              lh={1.6}
            >
              Add it once — the pharmacy bills your provider automatically on
              every order.
            </Text>
          </Box>
          ...
          {[
            {
              icon: TbShieldCheck,
              color: '#12B76A',
              text: 'Medications covered by your provider',
            },
            {
              icon: TbCurrencyDollar,
              color: '#F59F00',
              text: "Pay only what insurance doesn't cover",
            },
            {
              icon: TbClock,
              color: SavedColors.Primaryblue,
              text: 'Verified within 24 hours, applied automatically',
            },
