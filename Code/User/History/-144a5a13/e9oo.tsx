...
16. **Actor/Auditor ** — in the every log there should be the actor information as well specially in the reports or in the order details or approvals  what (staff actions log).

17. **Report section** — Reporting/analytics page for insurance or pharmacy.

18. **Delivery schedule** — A schedule view for deliveries.
19. one section for order approval history to both pharmcist and insurance interface
20. change the name of the upload in the insurnace bacause it doesnt mean it should be something like customer should understand this is where they place and order with inusrnace or with cashn
21. add a logic in the upload prescription page that the customer could type the medicine name as well like if the payment method is cash the prescription image should not be mendatory and also you can change the inpur prescription to image and text idk you know better
