...
20. change the name of the upload in the insurnace bacause it doesnt mean it should be something like customer should understand this is where they place and order with inusrnace or with cash
