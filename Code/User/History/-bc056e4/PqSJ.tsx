...
function TableContent({
  ...
  // Merge colorScheme into theme for styled components
          ...
          {currentRowActions.length > 0 && (
            <Table.Td
              style={{
                ...
                width: '60px',
                textAlign: 'center',
                // Disable pointer events on the cell itself so clicking
                // empty space in this cell does NOT trigger the row onClick
                pointerEvents: 'none',
              }}
              onClick={(e) => e.stopPropagation()} // fallback safety
            >
              <Menu
                shadow="md"
                width={200}
              ...
              >
                <Menu.Target>
                  <ActionIcon
                    ...
                    color="gray"
                    size="sm"
                    // Re-enable pointer events only on the icon button itself
