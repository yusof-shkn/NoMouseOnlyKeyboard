...
export const CompletePurchaseModal: React.FC<CompletePurchaseModalProps> = ({
  ...
  // ── Invoice number state — only used when receiveImmediately = true ──
  ...
  // ── No validation — invoice is only relevant when checkbox is checked ──
  const handleConfirm = () => {
          ...
          <Stack gap="sm">
            ...
            {receiveImmediately && isAdmin && (
              <TextInput
                ...
                description="Optional — enter if you have the supplier invoice"
