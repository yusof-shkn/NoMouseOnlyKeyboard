...
const FormPanel = styled.div`
  ...
  @media(max-width:800px){min-height:100vh;padding:0;display:flex;flex-direction:column;
...
const MobileHero = styled.div<{ $lifted?: boolean }>`
  display:none;
  @media(max-width:800px){border:1rem red solid;display:${(p) => (p.$lifted ? 'none' : 'flex')};flex-direction:column;align-items:center;position:relative;text-align:center;flex-shrink:0;
