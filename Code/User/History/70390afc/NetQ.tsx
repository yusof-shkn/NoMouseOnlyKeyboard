...
import { SingleItemBatchModal } from '@features/purchase/components/POP/components/SingleItemBatchModal'
import { ReceiveImmediatelyBatchModal } from '@features/purchase/components/POP/components/ReceiveImmediatelyBatchModal'
import { DeletedUsersModal } from '@features/main/components/usersManagement/components/DeletedUsersModal'
import { ChangePasswordModalContent } from '@features/authentication/components/profile/ChangePasswordModalContent'
import {
  CreateBudgetModalContent,
  AddEditBudgetItemModalContent,
} from '@features/AccountingAndFinance/components/BudgetManagement/BudgetModalContents'
...
> = {
  ...
  'complete-purchase': CompletePurchaseModal,
  'single-item-batch': SingleItemBatchModal,
  'receive-immediately-batch': ReceiveImmediatelyBatchModal,
  'deleted-users': DeletedUsersModal,
...
const getModalTitle = (
  ...
  if (type === 'permission-matrix') {
    return props?.preselectedRoleId ? `Permission Matrix` : 'Permission Matrix'
  }
