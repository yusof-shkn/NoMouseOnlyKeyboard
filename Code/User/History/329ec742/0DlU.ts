...
/**
 * Confirmed columns on cash_flow_transactions table:
 ...
 *
 * Does NOT have: account_id, receipt_number, account_number, bank_name,
 *               entry_date, cash_in, cash_out, net_cash_flow,
 *               running_balance_by_activity, account_name
 */
export interface CashFlowTransaction {
  ...
  // ── Client-side derived convenience fields ───────────────────────────────
