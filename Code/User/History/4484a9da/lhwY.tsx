...
const ThreeColGrid = styled.div`
  ...
  grid-template-areas:
    "patient  summary      prescription"
    "alerts   summary      prescription"
    "medtable medtable     medtable";
  gap: 20px;
...
const OrderDetailsArea = styled.div`
        ...
        <PageContainer>
          {/* ══ TOP STRIP ══ */}
              ...
              <Group gap={6}>
                ...
                <Text size="xs" c="dimmed" fw={500} style={{ letterSpacing: '0.05em' }}>
                  Order
                </Text>
                <Text
                  size="xs"
          ...
          <ThreeColGrid>
            ...
            <PatientArea>
                ...
                <Group gap={10} align="center" wrap="wrap">
                  ...
                  {(order.profiles as { is_chronic?: boolean } | null)?.is_chronic && (
                    <Badge size="sm" color="red" variant="light" leftSection={<TbUser size={10} />}>
                      Chronic patient
                    </Badge>
                  )}
                  <Text
                ...
                <CardBody>
                  ...
                  <Stack gap={8} mb={16}>
                    ...
                    <Group justify="space-between">
                      ...
                      <Text size="xs" fw={600}>{meds.filter((m) => m.in_stock).length} items</Text>
                    </Group>
                    {pricingSummaryVisible && (
                      <Group justify="space-between">
                        <Text size="xs" c="dimmed">Customer pays</Text>
                        <Text size="sm" fw={800} c="lotusCyan" style={{ letterSpacing: '-0.3px' }}>
            ...
            {/* ── Medication Area — row 3, cols 1-2 ──────────────────────── */}
            <MedicationArea>
              ...
              <Card>
                ...
                >
                  ...
                  {order.cash_only ? (
                    <Badge color="orange" variant="light" size="xs" leftSection={<TbCurrencyDollar size={10} />}>
                      Cash-only
                    </Badge>
                  ) : insuranceVerified ? (
                    <Badge color="teal" variant="light" size="xs" leftSection={<TbShieldCheck size={10} />}>
                      Insured
                    </Badge>
                  ) : (
                    <Badge color="orange" variant="light" size="xs" leftSection={<TbShieldOff size={10} />}>
                      Unverified
                    </Badge>
                  )}
                </CardHeader>
              ...
              {showAssignPanel && (
                <Card
                  id="rider-section"
                  style={{ borderColor: 'rgba(8,145,178,0.2)', borderWidth: 1 }}
                >
                  <CardHeader>
                    <Box style={{ flex: 1 }}>
              ...
              {/* Financial Summary + Smart Routing */}
              {/* Financial Summary */}
              {pricingSummaryVisible &&
                (() => {
            ...
            {/* ── Prescription Area — rows 1-2, col 3 ────────────────────── */}
            <PrescriptionArea>
            ...
            {/* ── Order Details Area — row 3, col 3 ──────────────────────── */}
          </ThreeColGrid>
        </PageContainer>
      </PortalPageWrap>
      {/* ── Fixed Action Bar ── */}
      <FixedActionBar>
        ...
        {!['rejected', 'cancelled', 'delivered'].includes(order.status) && (
          <Button
            ...
            size="md"
            style={{ background: 'var(--mantine-color-body)', border: '1px solid rgba(239,68,68,0.3)' }}
          >
            Reject Order
          </Button>
        )}
