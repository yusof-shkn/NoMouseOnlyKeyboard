...
export default function PharmacyOrderDetail(): JSX.Element {
  ...
  // Scroll to rider assignment section if navigated with #rider-section hash
  useEffect(() => {
    if (location.hash === '#rider-section') {
      // Wait for the panel to render (order data loads async)
      const tryScroll = () => {
        const el = document.getElementById('rider-section')
        if (el) {
      ...
      tryScroll()
      const t = setTimeout(tryScroll, 800)
  ...
  const savePricing = async (): Promise<void> => {
    ...
    const { error: orderErr } = await supabase
      ...
      .update({
        ...
        total_amount: cashTotal + deliveryFee,
          ...
          >
            ...
            >
              ...
              <Box>
                ...
                <Text
                  ...
                  mt={2}
                >
                  If the rider calls because the customer&apos;s QR code
                  won&apos;t scan, read them this OTP. The rider enters it
                  manually to confirm delivery.
                </Text>
              </Box>
            </Group>
            <Alert
            ...
            >
              <Text
                ...
                fw={600}
              >
                Only share this OTP with the assigned delivery rider over the
                phone
              </Text>
              <Text
                size="xs"
                ...
                c="dimmed"
              >
                Never give this to the customer directly — the rider must enter
                it on their device.
              </Text>
            </Alert>
