...
def main():
    ...
    if args.command == "scrape":
        ...
        # ── Format prompt: ask before any destructive/idempotent seed ──────────
        if args.company_id is not None and not args.clear:
            from template_seeder import prompt_format_company
            prompt_format_company(args.company_id)
