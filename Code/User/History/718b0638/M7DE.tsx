...
export default function EditProfile() {
  ...
  // Bug 4: When navigating here from the "Add Insurance Now" modal, auto-check
  // the insurance checkbox and scroll to the insurance section
  useEffect(() => {
    if (
      (location.state as { openInsurance?: boolean } | null)?.openInsurance &&
      !loading
    ) {
