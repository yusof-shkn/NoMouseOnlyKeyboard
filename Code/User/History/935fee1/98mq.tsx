...
const notifIcon = (type: string): JSX.Element => {
  if (type === 'delivered' || type === 'out_for_delivery')
    return <TbPackage size={14} />
  if (type.includes('deliver') || type.includes('dispatch'))
    return <TbPackage size={14} />
    ...
    <PageWrapper>
      ...
      <Shell>
        ...
        <Box
          px={16}
          py={10}
          style={{ background: '#fff', borderBottom: '1px solid #eef2f8' }}
        >
          <Group
