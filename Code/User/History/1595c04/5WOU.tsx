...
const features = [
  {
    ...
    desc: 'Chat with customers about their orders in real time',
  },
  {
    Icon: TbShieldCheck,
    title: 'Insurance Support',
    desc: 'Verify and update insurance claim statuses',
  },
  {
    Icon: TbUsers,
    title: 'Customer Management',
    desc: 'View all orders and resolve customer issues',
  },
]
  ...
  return (
    <Page>
      <BrandPanel>
        ...
        >
          Handle customer queries, manage insurance verifications, and monitor
          all active orders from one place.
        </Text>
            ...
            <Stack gap={16}>
              <InputWrap>
                <FormInput
                  ...
                  control={control}
                  label="Staff Email"
                  placeholder="support@medideliver.com"
              ...
              >
                ...
                >
                  🔒 This portal is for support staff only. Accounts are created
                  by administrators.
                </Text>
              </Box>
              <PrimaryBtn
