    ...
    try {
      ...
      notifications.show({
        ...
        message: requiresApproval
          ...
          : `Partial return ${returnRecord.return_number} processed. Refund: ${totalRefund.toLocaleString()}`,
                ...
                >
                  ...
                  >
                    ...
                    <Text
                      ...
                      fw={500}
                    >
                      UGX {item.unit_price.toLocaleString()} / unit
                    </Text>
                  </Stack>
                  ...
                  >
                    ...
                    {qty > 0 && (
                      <Text
                        ...
                        ta="right"
                      >
                        + {(qty * item.unit_price).toLocaleString()}
                      </Text>
                    )}
                  </Group>
                </Group>
