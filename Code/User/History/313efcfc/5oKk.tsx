...
const PO_STATUS_MAP: Record<string, StatusDotConfig> = {
  ...
  approved: {
    dot: 'var(--mantine-color-cyan-5)',
    text: 'var(--mantine-color-cyan-7)',
    label: 'Approved',
  },
  partially_received: {
    dot: 'var(--mantine-color-teal-5)',
...
const PO_PAYMENT_STATUS_MAP: Record<string, StatusDotConfig> = {
  ...
  overdue: {
    dot: 'var(--mantine-color-red-7)',
    text: 'var(--mantine-color-red-9)',
    label: 'Overdue',
  },
}
